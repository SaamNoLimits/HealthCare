        ...
        <header className="bg-gray-950/80 backdrop-blur-md border-b border-gray-800/50 sticky top-0 z-50">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center h-16">
                        ...
                        {navigation.map((item) => (
                            <Link
                                ...
                                className={classNames(
                                    'nav-link',
                                    pathname === item.href ? 'nav-link-active' : 'text-gray-300 hover:text-white'
                                )}
                            >
                                {item.name}
                            </Link>
                    ...
                    <button
                        onClick={toggleTheme}
                        className="p-3 rounded-xl text-gray-300 hover:text-white hover:bg-gray-800/50 transition-all duration-300 group"
                    ...
                    {/* Mobile menu button */}
                    <button className="md:hidden p-3 rounded-xl text-gray-300 hover:text-white hover:bg-gray-800/50 transition-all duration-300">
